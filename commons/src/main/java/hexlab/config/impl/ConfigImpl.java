...
import hexlab.config.Config;
import hexlab.config.ConfigException;
import hexlab.config.ConfigIncluder;
import hexlab.config.ConfigObject;
import hexlab.config.ConfigOrigin;
...
public class ConfigImpl {
    ...
    public static ConfigValue fromAnyRefWithComments(Object object, List<String> comments) {
        ConfigOrigin origin = SimpleConfigOrigin.newSimpleWithComments(comments);
        return fromAnyRef(object, origin, FromMapMode.KEYS_ARE_KEYS);
    }
