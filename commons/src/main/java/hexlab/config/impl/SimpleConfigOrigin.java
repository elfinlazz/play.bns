...
import hexlab.config.impl.SerializedConfigValue.SerializedField;
...
final class SimpleConfigOrigin implements ConfigOrigin {
    ...
    static SimpleConfigOrigin newSimpleWithComments(List<String> comments) {
        return new SimpleConfigOrigin("", -1, -1, OriginType.GENERIC, null, comments);
    }
